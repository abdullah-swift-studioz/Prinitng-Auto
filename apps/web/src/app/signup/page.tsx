                ...
                <div className="auth-content">
                    ...
                    <form className="auth-form" onSubmit={handleRegister}>
                        ...
                        <button type="submit" className="submit-btn" disabled={loading}>
                            <span className="submit-btn-text">{loading ? 'Creating...' : 'Sign Up'}</span>
                        </button>
                    </form>
                    
                    <div className="auth-switch">
                        Already have an account? <button className="switch-link" onClick={() => router.push(`/login?kiosk_id=${kioskId}`)}>Login</button>
                    </div>
                </div>
            </div>
        </>
